...
locals {
  build_by          = "Built with: HashiCorp Packer ${packer.version}"
  ...
  vm_name             = "${var.vm_guest_os_family}-${var.vm_guest_os_name}-${var.vm_guest_os_version}-${local.build_version}-${var.vm_cpu_count}C-${var.vm_mem_size}RAM-${var.vm_disk_size}DISK"
...
build {
  ...
  post-processor "manifest" {
    ...
    custom_data = {
      ...
      vsphere_vcenter_server   = var.vsphere_vcenter_server
